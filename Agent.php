...
<html>
	...
	<body>
		...
		<p style="font-family: Roboto; font-size: 0.70em; color: #595959; margin-left:16px;">Registro de Agente LEAN </p> 
		<hr style="color: #FFFFFF;">

		<!-- <form action="#" name="AgentForm" method="post" onsubmit="return ValidateAgent()"> -->
...
<input type="submit" name="registrarse" value="Registrarse" class="agentregister">


<br/><br/>
<hr style="color: #FFFFFF;">
<input type="submit" name="cerrar" value="Cerrar" class="agentcerrar"><br/>
</div>
</form>
	</header>		
	</body>
