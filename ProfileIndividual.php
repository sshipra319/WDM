...
<header id="header">
  <nav id="nav-bar">
    ...
    <ul>
      <li>
        <a href="HomeIndividual.html">Inicio</a>
        <a href="ProfileIndividual.html"id="active">Individual</a>        
      </li>
    </ul>
  </nav>
</header>
  ...
  <div class= "container-image ">
	...
	<div class="IndiProfile">
		...
		<table id="tblProfile">
			...
			<tr id="rowProfile">
				<td id="colProfile"> <i class="fas fa-book"></i>&nbsp; Nombres del Inscrito</td>
				<td id="colProfile"><i class="fas fa-map-marker-alt"></i>&nbsp; 198 West 21st street,<br/> Suite 721 New York NY 10016</td>
				<td id="colProfile" rowspan="3"><img src="imagenes\user.png" width="140px" height="140px" /></td>
			</tr>

			<tr id="rowProfile">
				<td id="colProfile"> <i class="fas fa-book"></i>&nbsp; Apellidos del Inscrito</td>
    ...
    <img src="imagenes\user.png" width="140px" height="140px" style="float: right; margin-right: 80px; margin-top: -10px;" />  <br/>
    <input type="submitIndiProfile" name="submit" value="Seleccionar Foto">
 
	<br/>
<label id="IndiName">Apellido</label> <br/>
...
<p style="color: #595959; font-size: 0.70em; font-family: Roboto; float: left; margin-top: 4px;">Solo puede cambiar los datos (Telefono, Contrasena y Foto)</p>
