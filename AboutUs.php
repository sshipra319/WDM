  ...
  <nav>
    ...
    <ul>
      <li>
        ...
        <a href="AboutUs" id="active">Quienes Somos</a>
...
<main>
  <div class= "container-image ">
    <img src="imagenes\bannerabout.jpg"/>
  ...
  <div class="wrapper">
            ...
            <ul class="c" style="margin-left: 10px;padding-left: 20px; text-align: left;">
                <li>Dona material médico e insumos para Venezuela.</li>
                <li>A través de donaciones económicas</li>
                <li>Hazte voluntario.</li>
            </ul>
        
            <p style="color: black; font-size: 20px;"><b>¿DÓNDE ESTAMOS?</b></p>
            ...
            <ul class="l" >
                ...
                <li>Casa Aragón</li>
                <li>Caritas Parraquial de Mérida</li>
...
<p style="color: black; font-size: 20px;"><b>¿Qué es LEAN?</b></p>
            ...
            <p style="color: black; font-size: 20px;"><b>¿Cuáles son las actividades de LEAN?</b></p>
            ...
            <p style="color: black; font-size: 20px;"><b>¿Qu hacemos?</b></p>
