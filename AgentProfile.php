  ...
  <nav id="nav-bar">
    ...
    <ul>
      <li>
        ...
        <a href="AgentProfile.html" id="active">Agente</a>        
      </li>
    </ul>
  </nav>
</header>
  ...
  <div class= "container-image ">
	...
	<div class="IndiProfile">
		...
		<table id="tblProfile">
			...
			<tr id="rowProfile">
				<td id="colProfile"> <i class="fas fa-book"></i>&nbsp; Numero de Registro del Inscrito</td>
	...
	<br/>
<label id="IndiName">Numero de Registro del Inscrito</label> <br/>
<input type="text"id="Indilname"name="lastname"placeholder="Numero de Registro del Inscrito"><br/><br/><br/><br/>
