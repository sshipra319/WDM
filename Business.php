...
<html>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">	
	    ...
	    <title>Foundation Register</title>	
	    <style>
	    .error{
			color: red;
			font-size: 12px;
	...
	<body>
		...
		<header>
		<div class="registerFond">
		<p style="font-family: Roboto; font-size: 0.70em; color: #595959; margin-left:16px;">Registro Negocio o Fundacion </p> 
		<hr style="color: #FFFFFF;">

		<!-- <form action="#" name="BusinessForm" method="post" onsubmit="return ValidateBusiness()"> -->
...
<div class="radio">
	<label class="radioctrl">		
		<input type="radio" name="negocio1" value="negocio1">
		Tipo de negocio1
	</label>
	<label class="radioctrl" style="margin-left: 30px;">		
		<input type="radio" name="negocio2" value="negocio2">
		Tipo de negocio2
	</label>
	<label class="radioctrl" style="margin-left: 50px;">		
		<input type="radio" name="negocio3" value="negocio3" checked>
		Tipo de negocio3 
	</label>
	
</div><br/><br/>

<input type="submit" name="registrarse" value="Registrarse" class="businessregister">


<br/><br/>
<hr style="color: #FFFFFF;">
<input type="submit" name="cerrar" value="Cerrar" class="businesscerrar"><br/>
</div>
	</header>
